        ...
        <form action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex justify-between w-full">
                <a href="{{ route('client.index') }}"
                    class="border border-[#613bf1] hover:!bg-[#613bf1] hover:!text-[#ffffff] px-4 py-1 md:px-6 rounded-[5px] text-[#613bf1]">
                    Back
                </a>

                <button type="submit"
                    class="bg-[#613bf1] text-white px-4 py-1 md:px-6 rounded-[5px]">Submit</button>
            </div>
        </form>
    </div>
